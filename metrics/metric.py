...
class OGMFlowMetrics(object):
    ...
    def compute(self):
        res_dict={}
        res_dict['vehicles_observed_auc'] = self.observed_auc.compute()
        res_dict['vehicles_occluded_auc'] = self.occluded_auc.compute()

        res_dict['vehicles_observed_iou'] = self.observed_iou.compute()
        res_dict['vehicles_occluded_iou'] = self.occluded_iou.compute()
